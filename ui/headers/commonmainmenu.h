...
/*
	...
	MENUITEMONLYACTION(_position,_text,_action,_tipmenu)
...
itemDef { \
	...
	textstyle 2 \
	textscale 0.7 \
	rect MMENU_OFFSETITEMH MENU_ITEM_TITLE_Y MENU_ITEM_WIDTH_FULL MENU_ITEM_HEIGHT \
	decoration \
...
itemDef { \
	...
	text _text \
	rect MMENU_OFFSETITEMH _position MENU_ITEM_WIDTH_FULL MENU_ITEM_HEIGHT \
	action { \
		play MP_SND_SELECT; \
		close _closemenu; \
		open _openmenu; \
...
/* Unconditional menu ONLY WITH action to perform */
#define MENUITEMONLYACTION(_position,_text,_action,_tipmenu) \
itemDef { \
	name button \
	background MP_LONGBUTTONBG style 1 type ITEM_TYPE_BUTTON textstyle 2 textscale 0.5 textalign MMENU_ALIGNITEM textalignx 256 textaligny 24 forecolor MP_TEXTCOLOR visible 1 hexcolor 0 1 2 3 \
	text _text \
